...
function show_score()
{
    if(hide==1)
    {
        ...
        document.getElementsByClassName("bt")[1].innerHTML = "Click to Hide Score";
        hide=0;
    }
    else
    {
        document.getElementById("scr").style.display = "none";
        document.getElementsByClassName("bt")[1].innerHTML = "Click to Show Score";
        hide=1;
    }
}
...
$(document).ready(function () {
    ...
    $('#game li').click(function () {
        ...
        $("#three").hasClass('o') && $("#five").hasClass('o') && $("#seven").hasClass('o')) {
            ...
            $("#game li").removeClass('blue-gradient')
            $("#game li").removeClass('peach-gradient')
        }
         ...
         $("#three").hasClass('x') && $("#five").hasClass('x') && $("#seven").hasClass('x')) {
            ...
            count++
            $(this).text(o)
            $(this).addClass('disable o peach-gradient')
            ...
            count++
            $(this).text(x)
            $(this).addClass('disable x blue-gradient')
